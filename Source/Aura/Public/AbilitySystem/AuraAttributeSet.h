...
/*
 * 声明属性的宏，启动ue对于Health和Mana使用会挂掉
 */
/*#define ADD_ATTRIBUTE(ClassName, AttributeName, AttributeCategory) \
UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_##AttributeName, Category = AttributeCategory) \
